...
function ThankYouInner() {
  ...
  const title = useMemo(
    () => (incident ? `Case #${incident} submitted` : "Case submitted"),
    [incident]
  );
          ...
          {incident ? (
            <CardContent className="pt-0">
              ...
              <div className="mt-6 text-sm text-muted-foreground">
                <p>You’ll get an email when the review starts or if we need more details. You can track the status anytime from your dashboard.</p>
              </div>
